  ...
  <div class="box box-solid">
    <div class="box-body">
      ...
      <div class="row hide-for-letterhead">
        ...
        <div class="col-sm-6" id="logo_place_wrapper" style="{{ $invoice_layout->show_logo ? '' : 'display:none;' }}">
            <div class="form-group">
                {!! Form::label('logo_place', __('invoice.logo_place') . ':') !!}
                {!! Form::select('logo_place', [
                    'top_left' => 'Top Left',
                ...
                ], $invoice_layout->logo_place ?? 'top_middle', ['class' => 'form-control']) !!}
            </div>
        </div>
        <div class="col-sm-12">
          <div class="form-group">
  ...
  <div class="box box-solid">
    <div class="box-body">
      <div class="row">
        ...
        <div class="col-sm-3" id="barcode_place_wrapper" style="{{ $invoice_layout->show_barcode ? '' : 'display:none;' }}">
          <div class="form-group">
              {!! Form::label('barcode_place', __('invoice.barcode_place') . ':') !!}
              {!! Form::select('code_place', [
                  'top_left' => 'Top Left',
                  'top_middle' => 'Top Middle',
                  'top_right' => 'Top Right',
                  'bottom_left' => 'Bottom Left',
                  'bottom_middle' => 'Bottom Middle',
                  'bottom_right' => 'Bottom Right'
              ], $invoice_layout->barcode_place ?? 'bottom_right', ['class' => 'form-control']) !!}
          </div>
        </div>
        <div class="clearfix"></div>
        <div class="col-sm-3">
  ...
  <div class="box box-solid">
    <div class="box-body">
      <div class="row">
        ...
        <div class="col-sm-12">
          <div class="form-group">
            {!! Form::label('footer_image', __('invoice.footer_image') . ':' ) !!}
...
<script type="text/javascript">
  __page_leave_confirmation('#add_invoice_layout_form');
    ...
    $(document).ready(function () {
        $('#show_logo').on('ifChanged change', function() {
            if ($(this).is(':checked')) {
                $('#logo_place_wrapper').show();
            } else {
                $('#logo_place_wrapper').hide();
            }
        });
    });
</script>
