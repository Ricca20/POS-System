...
class InvoiceLayoutController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            $validator = Validator::make($request->all(), [
                ...
                'invoice_image' => 'mimes:jpeg,gif,png|1000',
            ]);
            ...
            if($request->hasFile('footer_image')){
                ...
                $input['footer_image'] = 'invoice/' . $fileName;
            }
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            $validator = Validator::make($request->all(), [
                'logo' => 'mimes:jpeg,gif,png|1000',
                'footer_image' => 'mimes:jpeg,gif,png|1000',
            ]);
            ...
            $input = $request->only(['name', 'header_text',
                ...
                'sales_person_label', 'prev_bal_label', 'date_time_format', 'change_return_label', 'round_off_label', 'commission_agent_label', 'logo_place','code_place']);
            $business_id = $request->session()->get('user.business_id');
